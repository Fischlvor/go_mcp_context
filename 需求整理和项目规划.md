...
复用go_blog/docker-compose.base.yml中的postgres和redis

---

## 二十二、Interface 设计规划

### 22.1 核心 Interface 清单
...
1. **MCP 协议接口** - 让 CoStrict IDE 无缝调用
2. **向量检索能力** - 精准匹配用户查询
3. **多格式文档支持** - 适应各种文档类型
4. **版本管理** - 支持库的多个版本
5. **高性能** - 1 秒内返回结果
...
让 CoStrict 生成的代码更准确、更实用，显著减少"幻觉"现象。
